    ...
    return Scaffold(
      ...
      body: BlocConsumer<OnTuneBloc, OnTuneState>(
        listener: (context, state) {
          ...
          //   print("FetchedAudio state received. URL: ${state.audioUrl}");
                                          ...
                                          child: Stack(
                                            children: [
                                              AnimatedContainer(
                                                ...
                                                child: Image.network(
                                                  'https://www.thoughtco.com/thmb/BKfTiXHljrQxHpd2oq_w0Lz2Zi8=/4467x3049/filters:no_upscale():max_bytes(150000):strip_icc()/philcollins-GettyImages-85224863-58aca89f3df78c345b86a67b.jpg',
